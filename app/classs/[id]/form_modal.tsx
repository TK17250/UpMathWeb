...
import { getClassDataById } from '@/app/action/class';

// Define the prop types for UpdateClassModal component  
...
export default function UpdateClassModal({ isOpen, onClose, formAction }: UpdateClassModalProps) {
    ...
    useEffect(() => {
        async function fetchClassData() {
            ...
            try {
                ...
                setClassName(classDetails.c_name);
            } catch(err: any) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            >
                ...
                <h2 className="text-2xl font-bold text-white mb-4">แก้ไขชั้นเรียน</h2>
                ...
                >
                    ...
                    <div className="mb-4">
                        <label className="block text-white mb-1">พื้นหลัง (ถ้ามี)</label>
                        <input
                            type="file"   
                            ref={fileInputRef}
                        ...
                        <div 
                            className={`relative border-2 border-dashed rounded-lg p-6 cursor-pointer flex flex-col items-center justify-center transition-all duration-200 ${
                                isDragging
