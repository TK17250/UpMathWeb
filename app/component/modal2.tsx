          ...
          >
            ...
            <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
              <button
                ...
                className="inline-flex w-full justify-center rounded-md bg-[#70d387] px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-[#6ebc80] transition-all duration-300 sm:ml-3 sm:w-auto cursor-pointer"
              >
                {confirmButtonText}
              </button>
              <button
